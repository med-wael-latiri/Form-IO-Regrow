    ...
    <Row>
      <Col sm={6}>
        <Row>
          <Col>
            <p>
              ...
              Renderer. This provides the ability to render any Form within the
              Form.io platform, using the following syntax.
            </p>
          </Col>
        </Row>
        ...
        <Card className="my-2 p-4 text-center">
          ...
          <CopyBlock
            text={`<Form src={formSrc} onChange={onChangeHandler} onSubmit={onSubmitHandler} />`}
            theme={atomOneDark}
            language={"jsx"}
            codeBlock={true}
          />
